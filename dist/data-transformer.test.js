...
describe("processUserData", () => {
    ...
    test("should process valid user data correctly", () => {
        const result = (0, data_transformer_1.processUserData)(validUsers);
        expect(result).toHaveLength(2);
        expect(result).toEqual(validUsers);
    });
    // test 2 - empty array handling
    test("should return empty array when input is empty", () => {
        const result = (0, data_transformer_1.processUserData)([]);
    ...
    test("should handle non-array input", () => {
        ...
        const result = (0, data_transformer_1.processUserData)("not an array");
        expect(result).toHaveLength(0);
    ...
    test("should handle null and undefined input", () => {
        ...
        const result1 = (0, data_transformer_1.processUserData)(null);
        expect(result1).toHaveLength(0);
        // @ts-ignore - testing undefined input
        const result2 = (0, data_transformer_1.processUserData)(undefined);
